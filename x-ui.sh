...
#    bash <(curl -Ls https://raw.githubusercontent.com/MHSanaei/3x-ui/v2.5.5/install.sh)
...
#    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/MHSanaei/3x-ui/main/install.sh)${plain}"
#    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/MHSanaei/3x-ui/v2.5.5/install.sh)${plain}"
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/jameszeroX/3x-ui/main/install.sh)${plain}"
    echo ""
...
#    wget -O /usr/bin/x-ui -N https://raw.githubusercontent.com/MHSanaei/3x-ui/v2.5.5/x-ui.sh
    wget -O /usr/bin/x-ui -N https://github.com/jameszeroX/3x-ui/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
